        ...
        <div>
          <div style={{background: "linear-gradient(#818cf8 50%, #F2F5F7 50%)"}}>
              <div class="flex flex-col items-center justify-center">
                  <img src="https://avatars.githubusercontent.com/u/103104002?s=400&u=fe6790e6a567f81123b15f0effc05364cc4b19e8&v=4" alt="Profile Picture" class="rounded-full border-2  bg-white  mt-20"/>
                   <h1 class="font-bold text-xl mt-5 mb-1">{inform.nickname}<span class="text-text font-normal ml-2"></span></h1>

            ...
            {success ? (
                ...
                <section>
                    ...
                    className="mx-auto max-w-sm bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col lg">
                        ...
                        <div className="mb-4"></div>  
                        <label className="block text-grey-darker text-sm font-bold mb-2" htmlFor="ts">
                            * 기술 스택 (Tech Stack):
                        </label>
                        <ProductBar>
                            <ProductSearch onChange={handleDropTs} className="shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker">
                            {TS_LIST.map(el => {
                                return (
                                <option defaultValue="123" key={el.id}>
                                    {el.value}

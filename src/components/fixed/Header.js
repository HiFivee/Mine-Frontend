        ...
        <div>
            <nav className="flex flex-wrap items-center justify-between bg-indigo-600 p-6 pb-0">
                <div className="flex items-center flex-shrink-0 text-white mr-6">
                    ...
                    <Link to="/" className="font-semibold text-xl tracking-tight">Mine: Develop A Mine </Link>
                ...
                <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
                    <div className="text-sm lg:flex-grow">
                        ...
                        <Link to="/project/" className="block mt-4 lg:inline-block lg:mt-0 text-white hover:text-white mr-4">
                            프로젝트 
                        </Link>
